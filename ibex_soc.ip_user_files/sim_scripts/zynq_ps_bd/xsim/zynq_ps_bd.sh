...
#
# Script generated by Vivado on Wed Mar 25 15:54:49 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : zynq_ps_bd.sh
...
#
# Usage        : zynq_ps_bd.sh
#                zynq_ps_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zynq_ps_bd.sh [-reset_run]
#                zynq_ps_bd.sh [-reset_log]
#                zynq_ps_bd.sh [-help]
#
...
export RDI_DATADIR="E:/vivado24.2/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L xilinx_vip"

# script info
echo -e "zynq_ps_bd.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zynq_ps_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zynq_ps_bd xil_defaultlib.zynq_ps_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim zynq_ps_bd -key {Behavioral:sim_1:Functional:zynq_ps_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/zynq_ps_bd.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/vivado24.2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zynq_ps_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./zynq_ps_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: zynq_ps_bd.sh [-help]\n\
Usage: zynq_ps_bd.sh [-step]\n\
Usage: zynq_ps_bd.sh [-lib_map_path]\n\
Usage: zynq_ps_bd.sh [-reset_run]\n\
Usage: zynq_ps_bd.sh [-reset_log]\n\
Usage: zynq_ps_bd.sh [-keep_index]\n\
Usage: zynq_ps_bd.sh [-noclean_files]\n\n\
